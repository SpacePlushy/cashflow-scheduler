...
def test_day1_and_day30_small_adjustments():
    ...
    plan1.manual_adjustments = plan1.manual_adjustments + [Adjustment(day=1, amount_cents=100, note="d1+")]
    s1 = solve(plan1)
    ...
    plan2.manual_adjustments = plan2.manual_adjustments + [Adjustment(day=30, amount_cents=-100, note="d30-")]
    s2 = solve(plan2)
